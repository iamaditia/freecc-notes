...
function add (bookList, bookName) { // Fix the args first
  let newList = [...bookList]; // Copy the list to a new list
...
// Change code below this line
function remove (bookList, bookName) { // Fix the args first
  var newList = [...bookList]; // Copy the list to a new list
...
// Disclaimer: this is the suggested solution from freeCodeCamp
...
he function should return an array.
*/
...
function getRating(watchList){
  ...
  .reduce((avgRating, imdbRating) => avgRating + imdbRating) / watchList.filter(item => item["Director"] == "Christopher Nolan").length;
  // Only change code above this line
...
function splitify(str) {
  // Only change code below this line
  const newStr = str.split(/\W/); // \W = not word
  return newStr;
  // Only change code above this line
}
